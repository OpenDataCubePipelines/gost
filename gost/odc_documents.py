...
def load_odc_metadata(path: Path) -> Granule:
    ...
    elif raw_doc["product"]["name"] == "ga_s2am_ard_3" or raw_doc["product"]["name"] == "ga_s2bm_ard_3" or raw_doc["product"]["name"] == "ga_s2am_ard_3_viirs" or raw_doc["product"]["name"] == "ga_s2bm_ard_3_viirs":
